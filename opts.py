...
def arg_parser():
    ...
    # data-related
    parser.add_argument('--datadir', type=str, default='/data1/yq/008_clip_int/DualCoOp/datasets/VOCdevkit/VOC2007',
                        metavar='DIR', help='path to dataset file list')
    parser.add_argument('--input_size', default=224, type=int,
                        metavar='N', help='input image size')
    parser.add_argument('--train_input_size', type=int,
                        metavar='N', help='input image size')
    parser.add_argument('--num_train_cls', type=int,
                        default=100, help='input image size')
    parser.add_argument('--test_input_size', type=int,
                        metavar='N', help='input image size')
    parser.add_argument('--thre', default=0.5, type=float,
                        metavar='N', help='threshold value')
    parser.add_argument('--single_prompt', default='pos',
                        type=str, help='type of single prompt')
    ...
    # cfg file
    parser.add_argument('--config_file', default='./configs/models/rn101_ep50.yaml',
                        dest='config_file', type=str, help='network config file path')
    parser.add_argument('--dataset_config_file', default='/data0/home/yangqu/.allfiles/IntCLIP/configs/datasets/intentonomy.yaml',
                        dest='dataset_config_file', type=str, help='network config file path')


    # positive prompt & negative prompt
    parser.add_argument('--positive_prompt', dest="positive_prompt",
                        type=str, help='the initial positive prompt for mlc_clip')
    parser.add_argument('--negative_prompt', dest="negative_prompt",
                        type=str, help='the initial negative prompt for mlc_clip')
    # positive prompt & negative prompt number
    parser.add_argument('--n_ctx_pos', dest="n_ctx_pos",
                        type=int, help='the positive prompt for mlc coop')
    parser.add_argument('--n_ctx_neg', dest="n_ctx_neg",
                        type=int, help='the negative prompt for mlc coop')

    parser.add_argument('--lr', dest="lr", default=0.0004,
                        type=float, help='the learning rate')
    parser.add_argument('--loss_w', dest="loss_w", type=float,
                        default=0.03, help='the loss weights')

    parser.add_argument('--csc', dest='csc', default=True,
    ...
    parser.add_argument('-pp', '--partial_portion', dest="partial_portion", type=float, default=1,
    ...
    parser.add_argument('--finetune_last_layer', dest='finetune_last_layer', action='store_true',
                        help='specify if finetuning the backbone')
    ...
    parser.add_argument('--top_k', dest="top_k", default=3,
                        type=int, help='the top k in validation zsl')
